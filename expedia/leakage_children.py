...
def run_solution():
    ...
    ##
    best_hotels_od_ulc_hotelcountry = defaultdict(lambda: defaultdict(int))
    ...
    while 1:
        ...
        if user_location_city != '' and orig_destination_distance != '':
            ...
            ##
            if hotel_country!='':
                hsh = (hash('user_location_city_'+str(user_location_city) + '_orig_destination_distance_'
                + str(orig_destination_distance)+'hotel_country'+str(hotel_country)))
                best_hotels_od_ulc_hotelcountry[hsh][hotel_cluster]+=1
            ##
        ...
        if srch_destination_id != '' and hotel_country != '' and hotel_market != '' and book_year == 2014:
            ...
            #                +"_hotel_market_"+str(hotel_market)+"length"+str(length)+"is_package"+str(is_package)))
    ...
    while 1:
        ...
        hsh10 = (hash('user_location_city_'+str(user_location_city) + '_orig_destination_distance_'
                + str(orig_destination_distance)+'hotel_country'+str(hotel_country)))
        if hsh in best_hotels_od_ulc:
            if hsh10 in best_hotels_od_ulc_hotelcountry:
                d = best_hotels_od_ulc_hotelcountry[hsh10]
        ...
        #hsh20 = (hash('srch_destination_id_' +str(srch_destination_id) +"_hotel_country_" + str(hotel_country)
        #           +"_hotel_market_"+str(hotel_market)+"length"+str(length)+"is_package"+str(is_package)))
